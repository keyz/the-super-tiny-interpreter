...
//
//       /*
//        * We inject some native functions here.
//        * Feel free to ignore this part since it's just a hacky way to make `log` work.
//        */
//       if (closure.body && closure.body.type === 'NativeFuncCall') {
//         const { value: nativeFn } = closure.body;
//         const val = nativeFn(...vals);
//         return { val, env };
//       }
//
...
//
//       /*
//        * Again, just a hacky to make `log` work.
//        */
//       if (Prims[name]) {
//         return {
//           val: Prims[name],
